...
public class VRDebugMenuUI : MonoBehaviour
{
    ...
    [SerializeField] private TMPro.TextMeshProUGUI flyToggleText;
    [SerializeField] private TMPro.TextMeshProUGUI noclipToggleText;
    ...
    void UpdateMenuUI()
    {
        // Menu updates happen via button clicks
    }
    
    void UpdateButtonTexts()
    {
        if (flyToggleText != null)
        {
            flyToggleText.text = flyEnabled ? "FLY: ON" : "FLY: OFF";
        }
        
        if (noclipToggleText != null)
        {
            noclipToggleText.text = noclipEnabled ? "NOCLIP: ON" : "NOCLIP: OFF";
        }
    }
